            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4 col-md-3 col-lg-2">
                        <img src="{{ asset('storage/'.Auth::user()->foto.'' ) }}" class="img-thumbnail rounded-circle img-preview">
                    </div>
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input  @error('foto') is-invalid @enderror" id="foto" name="foto" onchange="previewImg2()">
